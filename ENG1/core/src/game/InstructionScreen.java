...
public class InstructionScreen extends ScreenAdapter {
    ...
    public InstructionScreen(ScreenController screenController, OrthographicCamera orthographicCamera) {
        ...
        String[] instructions = new String[] {
                ...
                "Plain Burger- Take two buns from the right side of the pantry, meat from the fridge, place it on the preparation station, cook the meat, place all the items on the assembly station, chop salad and then serve the customer",
